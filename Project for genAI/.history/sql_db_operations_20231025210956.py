...
class sql_db_operations:
    ...
    - values (tuple, optional): Values to be inserted into the query if it's a parameterized query.

    Returns:
    - list: List of dictionaries where each dictionary represents a row (if the query fetches data). Otherwise, None.
    """
    try:

...
class sql_db_operations:
    ...
    def create_populate_MenuItems(self):
        menuItems_excel_data = pd.read_excel("C:/Users/risha/OneDrive/Documents/CSYE7380/CSYE_7380_GenAI_Theory_Practical_Implementation/Project for genAI/Customers.xlsx")

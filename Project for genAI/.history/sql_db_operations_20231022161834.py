...
class sql_db_operations:
    ...
    def create_populate_SalesUnit(self):productsTable_excel_data = pd.read_excel("C:/Users/risha/OneDrive/Documents/CSYE7380/CSYE_7380_GenAI_Theory_Practical_Implementation/Project for genAI/Products Table.xlsx")
        print(productsTable_excel_data)
...
sql_conn.create_populate_() # creating and populating the Products table table

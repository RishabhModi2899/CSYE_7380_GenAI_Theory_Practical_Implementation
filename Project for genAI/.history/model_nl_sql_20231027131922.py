...
class SQLApp:
    ...
    def continue_(self, messages, temperature=0):
    ...
    def add(self, _):
        ...
        #Get the response. 
        response = self.continue_(context)
    ...
    def run_sql_query(self, _):
        ...
        if self.last_sql_response:
            print(f"{self.last_sql_response}")
...
interactive_conversation = pn.bind(app.add, button_conversation)
sql_execution = pn.bind(app.run_sql_query, run_sql_button)

parallel_layout = pn.Row(

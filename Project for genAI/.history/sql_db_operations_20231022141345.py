...
class sql_db_operations:
    ...
    def create_populate_OrdersTable(self):
        ordersTables_excel_data = pd.read_excel("C:/Users/risha/OneDrive/Documents/CSYE7380/CSYE_7380_GenAI_Theory_Practical_Implementation/Project for genAI/Order Items.xlsx")
        print(orde_excel_data)
